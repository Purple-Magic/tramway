...
3. Run `bundle exec appraisal rails-8.1 bundle exec rspec` to check that all tests are passing. If there are any failing tests, fix them and run the command again until all tests are passing.
