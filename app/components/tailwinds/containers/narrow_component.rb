  ...
  module Containers
    ...
    class NarrowComponent < Tramway::BaseComponent
      ...
      def container_classes
        theme_classes(
          classic: 'container p-4 flex align-center justify-center w-full mx-auto bg-gray-900 text-white',
          neomorphism: 'container p-4 flex align-center justify-center w-full mx-auto bg-gray-100 text-gray-700 ' \
